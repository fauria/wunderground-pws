...
describe('Tests for Node.js Weather Underground PWS API library', function(){
  ...
  it('should not let send observations without a timestamp');
  it('should not let send observations without a user name');
  it('should not let send observations without a password');
